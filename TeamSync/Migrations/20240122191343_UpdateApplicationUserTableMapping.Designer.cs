...
namespace TeamSync.Migrations
{
    ...
    [Migration("20240122191343_UpdateApplicationUserTableMapping")]
    partial class UpdateApplicationUserTableMapping
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeamSync.Data.Models.ApplicationUser", b =>
                {
                    b.HasOne("TeamSync.Data.Models.Employee", "Employee")
                        ...
                        .HasForeignKey("TeamSync.Data.Models.ApplicationUser", "EmployeeId");
